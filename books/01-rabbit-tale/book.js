...
function renderCoverPage(pageEl, page) {
    pageEl.innerHTML = `
...
function renderScenePage(pageEl, page) {
  ...
  `;
    setTimeout(() => {
        ...
        if (playBtn && audio) {
            ...
            if (sceneBody) {
                const wordSpans = sceneBody.querySelectorAll(".word");
...
function renderEndingPage(pageEl, page) {
    pageEl.innerHTML = `
